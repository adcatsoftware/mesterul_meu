...
class AmenajariInterioare extends StatefulWidget {
  @override
  _AmenajariInterioareState createState() => _AmenajariInterioareState();
}

class _AmenajariInterioareState extends State<AmenajariInterioare> {
  String judet;

  _AmenajariInterioareState();
  @override
        ...
        appBar: new AppBar(
          ...
          title: Center(
            child: new DropdownButtonFormField<String>(
              icon: Icon(Icons.map),
              value: judet,
              hint: Text("Amenajări interioare. Alege județul: "),
              onChanged: (judet) {
                setState(() {});
                this.judet = judet;
                print(judet);
...
//            ),
        ...
        body: Container(
            ...
            child: StreamBuilder(
                stream: Firestore.instance
                    .collection("mesteri")
                    .where('categorie', arrayContains: "Amenajări interioare")
