...
class Bucatarie extends StatefulWidget {
  @override
  _BucatarieState createState() => _BucatarieState();
}

class _BucatarieState extends State<Bucatarie> {
  String judet;
        ...
        appBar: new AppBar(
          ...
          title: Center(
            child: new DropdownButtonFormField<String>(
              icon: Icon(Icons.map),
              value: judet,
              hint: Text("Meșter Bucătărie. Alege județul: "),
              onChanged: (judet) {
                setState(() {});
                this.judet = judet;
                print(judet);
...
//            ),
        ...
        body: Container(
            ...
            child: StreamBuilder(
                stream: Firestore.instance
                    .collection("mesteri")
                    .where('categorie', arrayContains: "Bucătărie")
